...
class InstagramBot():
    ...
    def get_all_posts_urls(self, userpage):
        ...
        if self.xpath_exists(wrong_userpage):
            ...
            time.sleep(5)
            print(browser.find_element(By.XPATH,"/html/body/div[1]/div/div/section/main/div/ul/li[1]/span/span").text)
            posts_count = browser.find_element(By.XPATH,"//*[@id='react-root']/div/div/section/main"
                                                        "/div/ul/li[1]/span/span")
            print('----------', posts_count)
    ...
    def smart_unsubscribe(self, username):
        ...
        followers_button = browser.find_element("/html/body/div[1]/section/main/div/header/section/ul/li[2]/a/span")
        followers_count = followers_button.get_attribute("title")

        following_button = browser.find_element("/html/body/div[1]/section/main/div/header/section/ul/li[3]/a")
        following_count = following_button.find_element_by_tag_name("span").text
...
for user, user_data in users_settings_dict.items():
    ...
    my_bot.login()
    my_bot.get_all_posts_urls('https://www.instagram.com/astrogks/')
